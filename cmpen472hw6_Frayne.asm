...
inputBuffer        DS.B       13                          ; reserves space for input buffer
...
menuLoop    
                cmpb    #13                  ; check if char input counter above buffer limit (>13 bytes, longest input is 13 chars including enter at end)
...
cmpWrite                cmpa    #$57             ; check if a is 'W'
                        bne     cmpQ               ; branch if not 'W'
...
welcomeMsg         DC.B        'Welcome to the Simple Memory Access Program!',$0D,$0A
                   ...
                   DC.B        "QUIT: Quit menu program, run 'Type writer' program", $0D,$0A                   
